...
import SessionRepositoryPostgres from '../infrastructure/adapters/repository/navigation/session.repository.postgres';
import {NavigationSessionEntity} from '../infrastructure/adapters/repository/navigation/entity/session.entity';
import {
    PublicationVisitEntity,
} from '../infrastructure/adapters/repository/publication/entity/publicationVisit.entity';
import {
    PublicationSellerDataRequestEntity,
} from '../infrastructure/adapters/repository/publication/entity/publicationSellerDataRequest.entity';
import {SESSION_NAVIGATION_USE_CASES} from "./usecases/navigation";
...
@Module({
    ...
    providers: [
        ...
        {provide: 'SessionRepository', useClass: SessionRepositoryPostgres, scope: Scope.REQUEST},
